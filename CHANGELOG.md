...
- Named sessions (`--app <name>`) with per-session bridges, ports, and state; multi-app `run` script command with `apps.<name>` handles for cross-app flows (e.g. rider–driver E2E)
